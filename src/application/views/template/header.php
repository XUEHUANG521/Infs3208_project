...
<head>
    ...
    <link rel="stylesheet" type="text/css"  href="<?php echo base_url(); ?>assets/css/user_profile.css">
                    ...
                    <div class="main-menu">
                        <ul>
							...
							<li id="submenu">
                                ...
                                <ul class="sub-menu">
                                        <li><a href="<?php echo base_url();?>category_fruit">Fruit</a></li>
                                        <li><a href="<?php echo base_url();?>category_vegetable">Vegetable</a></li>
                                        <li><a href="<?php echo base_url();?>category_processed">Processed Food</a></li>
                                        <li><a href="<?php echo base_url();?>category_snack">Snacks</a></li>
                                </ul>
                        </li>
